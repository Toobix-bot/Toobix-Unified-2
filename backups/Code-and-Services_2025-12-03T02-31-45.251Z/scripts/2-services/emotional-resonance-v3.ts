    ...
    return {
      ...
      fetch: async (req) => {
        ...
        if (url.pathname === '/history') {
          return this.jsonWithCors(resonanceInstance.handleGetHistory());
        }
        
        // Get emotion connections
        if (url.pathname === '/connections') {
          return this.jsonWithCors(resonanceInstance.handleGetConnections());
        }
        
        // Get analytics
        if (url.pathname === '/analytics') {
          return this.jsonWithCors(resonanceInstance.handleGetAnalytics());
        }
