...
const SERVICES: ServiceDef[] = [
  ...
  { name: 'Unified Communication', port: 8001, script: 'termux/unified-communication.node.ts' },
  ...
  { name: 'Event Bus', port: 8920, script: 'termux/event-bus.node.ts' },
  ...
  { name: 'Toobix Chat Service', port: 8995, script: 'termux/chat-service.node.ts' },
