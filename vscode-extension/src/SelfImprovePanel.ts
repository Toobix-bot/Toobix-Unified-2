...
export class SelfImprovePanel {
  public static show(context: vscode.ExtensionContext, serviceManager: ToobixServiceManager) {
  ...
  private static getHtml(baseUrl: string, apiKey: string): string {
